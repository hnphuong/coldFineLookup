...
public enum ApiResponseCode {
    SUCCESS(HttpStatus.OK, 1, "CP200", "GLOBAL.SUCCESS"),
    ...
    UPDATED_SUCCESS(HttpStatus.OK, 0, "CP200", "GLOBAL.UPDATED_SUCCESS"),
    ...
    TIME_OUT(HttpStatus.REQUEST_TIMEOUT, 0, "CP408", "GLOBAL.TIME_OUT"),
    ...
    REQUEST_TIMEOUT(HttpStatus.REQUEST_TIMEOUT, 0, "CP408", "GLOBAL.REQUEST_TIMEOUT"),
