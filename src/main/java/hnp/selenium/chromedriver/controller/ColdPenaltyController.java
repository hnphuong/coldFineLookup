...
@AllArgsConstructor
@Slf4j
public class ColdPenaltyController {
    private ColdPenaltyService coldPenaltyService;
    private MessageUtils messageUtils;

    @PostMapping(value = "/test")
    public ResponseEntity<BodyResponseDTO<Object>> getColdPenalty(@Validated @RequestBody ColdPenaltyReq request) {
        ...
        dataRes.setStatus(1);
        return RestResponseWrapper.getResponse(ApiResponseCode.SUCCESS, i18nMessage, listMap);
    }
